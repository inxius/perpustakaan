                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            <li class="nav-item">
                              <h5 class="nav-link"><a href="<?php echo site_url('admin'); ?>">Home</a> / Kategori</h5>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="card-header">
                      <div class="row">
                        ...
                        <div class="col-md-8 col-lg-8">
                          <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#exampleModal" name="button"><i class="fas fa-plus"></i> Tambah Kategori</button>
                        </div>
                      </div>
                    </div>
                    <div class="card-body">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form role="form" action="<?php echo site_url('kategori/edit'); ?>" method="post">
              <input type="hidden" name="idKategori" id="editIdKategori" value="">
              <div class="card-body">
                <div class="form-group">
        ...
        $('#myTable tbody tr #edit').click(function(){
          ...
          $.ajax({
            ...
            success: function(data){
              $('#modalEdit #editIdKategori').val(data.dataKategoriById[0].idKategori);
              $('#modalEdit #editNama').val(data.dataKategoriById[0].namaKategori);
            }
          });
        });
