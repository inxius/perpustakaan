            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                <div class="text-center">
                  ...
                  ?>
                    <img class="img-fluid" src="<?php echo base_url("assets/img/$Gambar->gambar"); ?>" alt="Sampul Buku">
                  <?php
                  } ?>
                </div>
              </div>
                  ...
                  <div class="active tab-pane" id="settings">
                    ...
                    ?>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputKode" name="kodeBuku" placeholder="Kode Buku" value="<?php echo $buku->kode; ?>">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputJudul" class="col-sm-2 col-form-label">Judul</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputJudul" name="judulBuku" placeholder="Judul Buku" value="<?php echo $buku->judul; ?>">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputPengarang" class="col-sm-2 col-form-label">Pengarang</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputPengarang" name="pengarang" placeholder="Pengarang" value="<?php echo $buku->pengarang; ?>">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputISBN" class="col-sm-2 col-form-label">ISBN</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputISBN" name="isbn" placeholder="ISBN" value="<?php echo $buku->isbn; ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputTahun" name="tahun" placeholder="Tahun Terbit" value="<?php echo $buku->tahunTerbit; ?>">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="jmlHal" class="col-sm-2 col-form-label">Jumlah Halaman</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="jmlHal" name="jmlHal" placeholder="Jumlah Halaman" value="<?php echo $buku->jmlHal; ?>">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="jmlBuku" class="col-sm-2 col-form-label">Jumlah Buku</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="jmlBuku" name="jmlBuku" placeholder="Jumlah Buku" value="<?php echo $buku->jmlBuku; ?>">
                        </div>
                      </div>
